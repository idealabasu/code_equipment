...
# dxl_comm_result_1, dxl_error_1 = packetHandler.write1ByteTxRx(portHandler, DXL_ID_1, 65,0)
...
# current control
dxl_comm_result_1, dxl_error_1 = packetHandler.write1ByteTxRx(portHandler, DXL_ID_1, ADDR_PRO_OPERATING_MODE,DXL_OPERATING_is_CURRENT)
dxl_comm_result_1, dxl_error_1 = packetHandler.write1ByteTxRx(portHandler, DXL_ID_1, ADDR_PRO_TORQUE_ENABLE, TORQUE_ENABLE)
# dxl_comm_result_1, dxl_error_1 = packetHandler.write1ByteTxRx(portHandler, DXL_ID_1, ADDR_PRO_TORQUE_ENABLE, TORQUE_DISABLE)
DXL_GOAL_CURRENT = 0
dxl_comm_result_1, dxl_error_1 = packetHandler.write2ByteTxRx(portHandler, DXL_ID_1, ADDR_PRO_GOAL_CURRENT, DXL_GOAL_CURRENT)
# END current control
...
# DXL_GOAL_VELOCITY = 0
# dxl_comm_result_1, dxl_error_1 = packetHandler.write4ByteTxRx(portHandler, DXL_ID_1, ADDR_PRO_GOAL_VELOCITY, DXL_GOAL_VELOCITY)
